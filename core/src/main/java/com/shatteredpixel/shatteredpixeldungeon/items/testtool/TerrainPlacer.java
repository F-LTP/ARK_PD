...
public class TerrainPlacer extends ChallengeItem {
    {
...
//                        GLog.i("不能放置此类型的地形");
        ...
        public TerrainButton(int terrain) {
            ...
            switch (terrain) {
                ...
                default:
                    ...
                    icon(new Image(Dungeon.level.tilesTex(),x * 16, y * 16, 16, 16));
                    break;
            }
        }
    ...
    private final ArrayList<Integer> X = new ArrayList<>(Arrays.asList(DungeonTileSheet.CHASM,DungeonTileSheet.FLOOR,DungeonTileSheet.GRASS,DungeonTileSheet.EMPTY_WELL,
            ...
            DungeonTileSheet.FLAT_BOOKSHELF,DungeonTileSheet.FLAT_ALCHEMY_POT,DungeonTileSheet.WATER,DungeonTileSheet.FLAT_FURROWED_GRASS,DungeonTileSheet.FLOOR_ALT_1));
}